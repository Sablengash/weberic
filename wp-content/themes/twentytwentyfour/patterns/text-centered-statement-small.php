...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
	...
	<h1 class="wp-block-heading has-text-align-center has-x-large-font-size">
		<em>
		<br>
<b>Fatal error</b>:  Uncaught Error: Call to undefined function esc_html__() in C:\xampp\htdocs\Ujian_Eric\wp-content\themes\twentytwentyfour\patterns\text-centered-statement-small.php:19
Stack trace:
#0 {main}
  thrown in <b>C:\xampp\htdocs\Ujian_Eric\wp-content\themes\twentytwentyfour\patterns\text-centered-statement-small.php</b> on line <b>19</b><br>
</em>
</h1>
</div>